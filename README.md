...
### `searches.yaml`
Job search queries, target titles, locations, boards, and a priority-company
`watchlist`. Watchlist companies are searched first and their jobs are
highlighted in status and dashboard output.
