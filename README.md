...
| Stage | What Happens |
|-------|-------------|
| **1. Discover** | Scrapes 5 job boards + 44 Workday portals + 9 Greenhouse boards + 15 Lever sites + 30 direct career sites |
...
|---------|-----------|--------|--------|
| Job discovery | 5 boards + Workday + Greenhouse + Lever + direct sites | LinkedIn only | One board at a time |
| AI scoring | 1-10 fit score per job | Basic filtering | Your gut feeling |
| Resume tailoring | Per-job AI rewrite | Template-based | Hours per application |
| Auto-apply | Full form navigation + submission | LinkedIn Easy Apply only | Click, type, repeat |
| Supported sites | Indeed, LinkedIn, Glassdoor, ZipRecruiter, Google Jobs, 44 Workday portals, 9 Greenhouse boards, 15 Lever sites, 30 direct sites | LinkedIn | Whatever you open |
...
- `config/greenhouse.yaml` and `config/greenhouse/` - profile-aware Greenhouse board registry (9 preconfigured)
